...
const auto ZXCOST = 10;//每步走直线的代价
const auto XXCOST = 14;//每步走斜线的代价
const auto MAPTYPE = 2;//地图类型
const auto ROWS = 60;//地图行数 //60
const auto COLS = 50;//地图列数 //50
const auto Swidth = 1200;//1200
const auto Sheight = 1400;//1400
const auto ratio = 1;//绘图比例
